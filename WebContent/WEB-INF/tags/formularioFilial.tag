...
<campo:campoTexto id="ie" maxLength="15" minLength="1" anotherclass="number15" classe="${classe}" required="false" type="text" icon="glyphicon glyphicon-globe" value="${ie}" placeholder="Inscrição Estadual"/>
<campo:campoTexto id="im" maxLength="15" minLength="1" anotherclass="number15" classe="${classe}" required="false" type="text" icon="glyphicon glyphicon-globe" value="${im}" placeholder="Inscrição Municipal"/>
